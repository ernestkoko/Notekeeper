...
public class NoteActivityViewModel extends ViewModel {
    public static final String ORIGINAL_NOTE_COURSE_ID =
            "com.buildappswithernest.notekeeper.ORIGINAL_NOTE_COURSE_ID";
    public static final String ORIGINAL_NOTE_TITLE =
            "com.buildappswithernest.notekeeper.ORIGINAL_NOTE_TITLE";
    public static final String ORIGINAL_NOTE_TEXT =
            "com.buildappswithernest.notekeeper.ORIGINAL_NOTE_TEXT";
